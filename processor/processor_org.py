...
def do_train(cfg,
    ...
    #nn.Module.state_dict = safe_state_dict
        ...
        try: 
                ...
                for n_iter, (img, vid, target_cam, target_view) in enumerate(train_loader):
                    ...
                    if (n_iter + 1) % log_period == 0:
                        ...
                        base_lr = optimizer.param_groups[0]["lr"]     # works with any scheduler
                        logger.info(
            ...
            # Catch recursion errors and continue training
            logger.error(f"Recursion error during epoch {epoch}: {str(e)}")
