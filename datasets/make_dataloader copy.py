...
def make_dataloader(cfg):
    # ... existing code to setup transforms ...

    num_workers = cfg.DATALOADER.NUM_WORKERS
    dataset = init_dataset(cfg.DATASETS.NAMES, root=cfg.DATASETS.ROOT_DIR) # Ensure ROOT_DIR is passed

    # ... rest of the dataloader creation logic using 'dataset' ...

    # --- Add logging for verification ---
    logger = logging.getLogger("transreid.dataset")
    logger.info(f"Initializing dataset '{cfg.DATASETS.NAMES}' with root '{cfg.DATASETS.ROOT_DIR}'")
